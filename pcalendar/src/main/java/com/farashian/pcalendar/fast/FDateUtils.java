...
public class FDateUtils {
    ...
    static PersianDateFormat     dateTime1       = new PersianDateFormat("(00 yyyy) - (0 yy) -(1 MMMM) -(2 MMM) -(3 MM) -(4 M) -(5 dddd) -(6 ddd) -(7 dd) -(8 d) -(9 HH:mm:ss)");
    ...
    public static String getAllPatterns(Date date) {
        PersianCalendar pdate = new PersianCalendar(date.getTime());
        return dateTime1.format(pdate);
    }
