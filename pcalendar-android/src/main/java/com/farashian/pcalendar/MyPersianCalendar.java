...
public class MyPersianCalendar extends Calendar implements Parcelable {
     ...
     */
    protected MyPersianCalendar(Parcel in) {
        this(); // Initialize with default constructor

        // Read the data in the SAME ORDER as writeToParcel
        ...
        // Read first day of week if needed
    ...
    public static final Creator<MyPersianCalendar> CREATOR = new Creator<MyPersianCalendar>() {
        @Override
        public MyPersianCalendar createFromParcel(Parcel in) {
            return new MyPersianCalendar(in);
        }

        @Override
        public MyPersianCalendar[] newArray(int size) {
            return new MyPersianCalendar[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        // Write in the SAME ORDER as constructor reads
    ...
    /**
     * Create from Parcel (alias for CREATOR.createFromParcel)
     */
    public static MyPersianCalendar fromParcel(Parcel parcel) {
        return CREATOR.createFromParcel(parcel);
    }

    /**
     * Create from another Parcelable calendar
     */
    public static MyPersianCalendar fromParcelable(Parcelable parcelable) {
        if (parcelable instanceof MyPersianCalendar) {
            return (MyPersianCalendar) parcelable;
        }
        return new MyPersianCalendar();
    }

    /**
     * Get as Android Bundle (for passing between activities/fragments)
     * @return Bundle containing calendar data
     */
    ...
    /**
     * Create MyPersianCalendar from Android Bundle
     * @param bundle Bundle containing calendar data
     * @return New MyPersianCalendar instance
     */
    public static MyPersianCalendar fromBundle(android.os.Bundle bundle) {
        if (bundle == null) {
            return new MyPersianCalendar();
        }

        MyPersianCalendar calendar = new MyPersianCalendar();
        ...
        if (bundle.containsKey("timeInMillis")) {
            ...
            // Restore from Persian date components
    ...
    /**
     * Get date as SpannableString for Android (allows styling)
     */
    public android.text.SpannableString toSpannableString() {
        return new android.text.SpannableString(getLongDate());
    }
